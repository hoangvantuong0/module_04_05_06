...
import com.example.aspect_log.model.Province;
import com.example.aspect_log.service.CustomerService;
import com.example.aspect_log.service.ProvinceService;
...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ModelAndView showInformation(@PathVariable Long id) throws DuplicateEmailException {
        try {
